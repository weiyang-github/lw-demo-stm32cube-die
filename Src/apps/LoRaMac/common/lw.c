...
*/
int lw_se_id_set(lw_se_id_t type, const uint8_t *buf)
{
    MibRequestConfirm_t mibReq;
    ...
    case LW_SE_ID_DEVEUI:
        ...
        memcpy1(mibReq.Param.DevEui, buf, SE_EUI_SIZE);
        break;
    case LW_SE_ID_APPEUI:
        mibReq.Type = MIB_JOIN_EUI;
        memcpy1(mibReq.Param.JoinEui, buf, SE_EUI_SIZE);
        break;
    case LW_SE_ID_APPSKEY:
        mibReq.Type = MIB_APP_S_KEY;
        memcpy1(mibReq.Param.AppSKey, buf, SE_KEY_SIZE);
        break;
    case LW_SE_ID_NWKSKEY:
        mibReq.Type = MIB_S_NWK_S_INT_KEY;
        memcpy1(mibReq.Param.SNwkSIntKey, buf, SE_KEY_SIZE);
        break;
    case LW_SE_ID_APPKEY:
        mibReq.Type = MIB_NWK_KEY;
        memcpy1(mibReq.Param.NwkKey, buf, SE_KEY_SIZE);
        break;
    default:
        return LORAMAC_STATUS_PARAMETER_INVALID;
    }
